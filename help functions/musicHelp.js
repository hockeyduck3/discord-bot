...
module.exports = function musicHelp(interaction) {
    const musicMessage = new EmbedBuilder()
        ...
        .addFields(
            { name: '\u200B', value: '\u200B' },
            { name: 'Playing music', value: 'For me to actually start playing music I first need to know what you wanna hear. So you can say "/play" and then give me a song name or a youtube link!', inline: true},
            ...
            { name: '\u200B', value: '\u200B' },
            { name: 'See the queue', value: 'Did you already forget what songs you put into the queue? Well I guess if you want I can show you what\'s coming up next. Just say "/queue" and I will show you the last song I played, the song that I am currently playing, and since you asked nicely I will show you the next 10 songs. Sound good? 👍' },
            { name: '\u200B', value: '\u200B' }
        )
        .setFooter({
